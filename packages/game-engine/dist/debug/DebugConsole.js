...
exports.DebugConsole = exports.LogLevel = void 0;
 ...
 */
class DebugConsole extends eventemitter3_1.EventEmitter {
    constructor() {
        super();
        this.logs = [];
        this.maxLogs = 1000;
     ...
     */
    drawDebugPoint(position, color = '#ff0000', duration = 0) {
    ...
    drawDebugLine(start, end, color = '#ff0000', duration = 0) {
        this.visualDebugItems.push({
            type: 'line',
    ...
    drawDebugRect(position, width, height, color = '#ff0000', duration = 0) {
        this.visualDebugItems.push({
            type: 'rect',
    ...
    drawDebugCircle(center, radius, color = '#ff0000', duration = 0) {
        this.visualDebugItems.push({
            type: 'circle',
    ...
    drawDebugText(position, text, color = '#ffffff', duration = 0) {
        this.visualDebugItems.push({
            type: 'text',
        ...
        document.addEventListener('keydown', (event) => {
            ...
            if (event.ctrlKey && event.shiftKey && event.key === 'D') {
                ...
                this.info('Debug', 'Debug dump:', {
                    ...
                    watchedVariables: Object.fromEntries(Array.from(this.watchedVariables.entries()).map(([name, getter]) => [name, getter()])),
