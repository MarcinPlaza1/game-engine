...
AuthMiddleware.ipConnections = new Map();
AuthMiddleware.MAX_CONNECTIONS_PER_IP = 10;
AuthMiddleware.RATE_LIMIT_WINDOW = 60000; // 1 minuta
// Blacklisted IPs
AuthMiddleware.blacklistedIPs = new Set([
